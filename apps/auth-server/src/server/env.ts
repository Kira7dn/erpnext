...
const schema = z.object({
  ...
  LARK_PO_BASE_APP_TOKEN: z.string().min(1).optional(),
  LARK_PO_DRAFT_TABLE_ID: z.string().min(1).optional(),
  LARK_PO_DRAFT_ITEM_TABLE_ID: z.string().min(1).optional(),
  LARK_PO_APPROVAL_CODE: z.string().min(1).optional(),
  LARK_PO_APPROVER_EMAIL: z.string().email().optional(),
  LARK_EVENT_ENCRYPT_KEY: z.string().min(1).optional(),
